#include <stddef.h>
#include <omp.h>
// multi-processor reduce_pixels! for MeasuredAsymmetric source and sink
void rpp3(double *sr1, double *sr2, double *sr3, long long *srCln, long long Nsr, long long Ncol,
          long long *idx, long long *ttl,
          double *sn1, double *sn2, double *sn3, long long *snCln,
          long long *snTar, long long Ntar
          )
{
  long long i,j,k,l,m,mytarget;
# pragma omp parallel shared(sr1,sr2,sr3,srCln,Nsr,Ncol,idx,ttl,sn1,sn2,sn3,snCln,snTar,Ntar) private(i,j,k,l,m,mytarget)
# pragma omp for
